			...
			<div class="col-md-10">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form name="updateMassage" class="form-horizontal" role="form" action="<%=request.getContextPath()%>/admin/showStaffDetail" id="editfrom" method="post" onsubmit="return check()">
