...
public class AdminController {
    ...
    public String showSign(Model model, Integer page) throws Exception {

    	List<ReportInfo> list = null;
    	PagingVO pagingVO = new PagingVO();
    	pagingVO.setTotalCount(adminService.getReportInfo());
    	if(page == null || page == 0) {
    		pagingVO.setToPageNo(1);
        ...
        model.addAttribute("reportInfoList", list);
        model.addAttribute("pagingVO", pagingVO);
