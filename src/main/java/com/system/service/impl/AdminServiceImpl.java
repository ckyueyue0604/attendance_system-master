...
public class AdminServiceImpl implements AdminService {
	...
	@Override
	public int getReportInfo() throws Exception {
		return reportInfoMapper.getReportInfo();
	}

	@Override
	public List<ReportInfo> findByPaging(int toPageNo) throws Exception {
        PagingVO pagingVO = new PagingVO();
        pagingVO.setToPageNo(toPageNo);

        return reportInfoMapper.findByPaging(pagingVO);
	}
